...
#JOIN, used to add a character inside the string like a , from a list
...
#SPLIT, Used for spliting a string from a chacarcter to use as reference to an array from a string
challenge = 'thirty days of python'
